...
class ev extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _evState();
}

class _evState extends State with TickerProviderStateMixin {
  @override
            ...
            child: Stack(
              children: <Widget>[
                TabBarView(
                  ...
                  children: <Widget>[
                    Image.asset("assets/images/ev.jpg"),
                    Image.asset("assets/images/ev.jpg"),
                  ],
                ),
                Container(
  ...
  _buildProductTitle() {
    return const Padding(
      ...
      child: Text(
        "NEDİO'NUN BU HAFTAYA ÖZEL BUNGALOV EVLERİ",
        style: TextStyle(
          fontSize: 16.0,
          color: Colors.white,
        ),
