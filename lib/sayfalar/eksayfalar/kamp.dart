...
class kamp extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _kampState();
}

class _kampState extends State with TickerProviderStateMixin {
  @override
            ...
            child: Stack(
              children: <Widget>[
                TabBarView(
                  ...
                  children: <Widget>[
                    Image.asset("assets/images/kamp.jpg"),
                    Image.asset("assets/images/kamp.jpg"),
                  ],
                ),
                Container(
  ...
  _buildProductTitle() {
    return const Padding(
      ...
      child: Text(
        "NEDİO'NUN BU HAFTAYA ÖZEL KAMP YERİ",
        style: TextStyle(
          fontSize: 16.0,
          color: Colors.white,
        ),
