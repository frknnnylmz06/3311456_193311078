...
class gezi extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _geziState();
}

class _geziState extends State with TickerProviderStateMixin {
  @override
            ...
            child: Stack(
              children: <Widget>[
                TabBarView(
                  ...
                  children: <Widget>[
                    Image.asset("assets/images/gezi.jpg"),
                    Image.asset("assets/images/gezi.jpg"),
                  ],
                ),
                Container(
  ...
  _buildProductTitle() {
    return const Padding(
      ...
      child: Text(
        "NEDİO'NUN BU HAFTAYA ÖZEL GEZİSİ",
        style: TextStyle(
          fontSize: 16.0,
          color: Colors.white,
        ),
